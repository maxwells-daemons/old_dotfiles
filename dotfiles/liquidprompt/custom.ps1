#######################################
# LIQUID PROMPT TEMPLATE FILE
# See: https://github.com/nojhan/liquidprompt/blob/master/liquid.ps1
#######################################
...
# Add working directory, with the final slash colored by permissions,
# virtualenv, and proxy
